/*
 * Exercise Arithmetic (Command-line arguments): Write a program called 
 * Arithmetic that takes three command-line arguments: two integers followed by
 * an arithmetic operator (+, -, * or /). The program shall perform the 
 * corresponding operation on the two integers and print the result. For 
 * example:
 *
 * > java Arithmetic <b>3 2 +</b>
 * 3+2=5
 *    
 * > java Arithmetic <b>3 2 -</b>
 * 3-2=1
